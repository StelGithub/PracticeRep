...
public class Reports {
    ...
    public static void setup() {
        file = new File(Bukkit.getServer().getPluginManager().getPlugin("Practice").getDataFolder(), "reports.yml");
        if (!file.exists())
            try {
                file.createNewFile();
...
//        });
    ...
    public static void reload() { info = YamlConfiguration.loadConfiguration(file); }
}
